...
namespace Astar.Base
{
    public class BaseMap
    {
        ...
        public BaseMap(int width, int height) : this(width, height, new Point(), new Point(width - 1, height - 1)) { }
        public BaseMap(int width, int height, Point startPoint, Point endPoint)
        {
            Width = width;
            Height = height;
